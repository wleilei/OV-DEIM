...
class DataConfig:   
    ...
    data_lvis_root: str = "/data/OG/lvis/"
    ann_lvis_file: str = "/data/OG/lvis/annotations/lvis_v1_minival_inserted_image_name.json"
...
class BackboneConfig:
    name: str = 'vit_tinyplus'
    weights_path: str = 'weights/dinov3/vittplus_distill.pt'
...
@dataclass
class EncoderConfig:
    in_channels: List[int] = field(default_factory=lambda: [256, 256, 256])
