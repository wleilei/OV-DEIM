...
from .utils import get_activation, TransformerEncoder, TransformerEncoderLayer
...
class SCDown(nn.Module):
    def __init__(self, c1, c2, k, s, act=None):
        super().__init__()
        if act is not None:
            print("Act in SD is", act)
        self.cv1 = ConvNormLayer_fuse(c1, c2, 1, 1, act=act)    # TODO, add activation for cv1 following YOLOv10
    ...
    def __init__(self,
        ...
        for _ in range(len(in_channels) - 1, 0, -1):
            ...
            self.fpn_blocks.append(
                RepNCSPELAN5(c1=c1, c2=c2, c3=c3, c4=c4, n=num_blocks, act=act)
            )
        ...
        for _ in range(len(in_channels) - 1):
            self.downsample_convs.append(
                SCDown(hidden_dim, hidden_dim, 3, 2, act=act)
            )
